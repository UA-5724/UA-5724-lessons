...
class Program
{
    static void Main()
    {
       ...
       //read new color
        ...
        //repaint white cars, take into account all cases (White, white, WHITE, WhItE)
        if (car1.Color.Equals("White", StringComparison.OrdinalIgnoreCase))
        {
                car1.Color = newColor;
            }
        if (car2.Color.Equals("White", StringComparison.OrdinalIgnoreCase))
        {
            car2.Color = newColor;
        }
        if (car3.Color.Equals("White", StringComparison.OrdinalIgnoreCase))
        {
            car3.Color = newColor;
        }
